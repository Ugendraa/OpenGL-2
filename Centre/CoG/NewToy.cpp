...
//AVAILABLE DOLLS
enum d{ CAP_MAN , DANCER}dollType=CAP_MAN;
...
void set_menu()
{
	...
	menuInit();
     ...
     if(dollType==CAP_MAN)
                           glutChangeToSubMenu(1, "Capman", MENU_CAPMAN_APPEARANCE);
     else
...
void title_display()
{
     ...
     glColor3fv(get_color(COLOR_TITLE_H1));
     drawstring(100,adjust-440,(char *)"CENTRE OF GRAVITY DOLL");
     

     //glColor3f(1.0,1.0,1.0);
     glColor3fv(get_color(COLOR_TITLE_H2));
     drawstring(100,adjust-400,(char *)"Submitted by");

     //delay();
     
     glColor3fv(get_color(COLOR_TITLE_TEXT1));
     drawstring(100,adjust-360,(char *)"Chirag Ravindra");
     
     //delay();
     
     //glColor3f(0.0,1.0,0.0);
     drawstring(100,adjust-320,(char *)"VI CSE A");
     //delay();

     //glColor3f(0.0,1.0,0.0);
     drawstring(100,adjust-280,(char *)"1BG11CS027");
    
     //delay();
     glColor3fv(get_color(COLOR_TITLE_TEXT2));
     setFont(GLUT_BITMAP_HELVETICA_12);
     drawstring(100,adjust-250,(char *)"Right click for options");
     //glutPostRedisplay();
glFlush();
}
